...
OVERRIDES = {
    "5f8c4a86-5605-4c6d-8176-55ba3501bad4": {
        ...
        "desc": "Детерминированный скрипт Бобби проверяет 10 Telegram-источников, два раздела Smart-Lab, блог ДОХОДЪ и новости Московской биржи, сохраняет новые материалы, ищет совпадения по ISIN, выпуску и эмитенту и при наличии результата отправляет Алексею одно уведомление по фиксированному шаблону. Для каждого источника показывает ✅ при успешной проверке или 🚫 при ошибке. ИИ не используется.",
        "additional": "Cron активен каждые 15 минут и выполняется скриптом Бобби без ИИ.\n\n"
        "Источники:\n"
        "• 10 Telegram-источников: GoodBonds, oblig_flood, Bonds_Wizzard_Chat, philippovich_bonds, ludomanechka, cbonds, probonds, ivolgavdo, marythebond и oblig_news.\n"
        ...
        "• Всего контролируется 14 адресов.\n\n"
