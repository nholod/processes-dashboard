...
OVERRIDES = {
    "5f8c4a86-5605-4c6d-8176-55ba3501bad4": {
        ...
        "desc": "Детерминированный скрипт Бобби сохраняет новые материалы, ищет совпадения по ISIN, выпуску и эмитенту и при наличии результата отправляет Алексею одно уведомление по фиксированному шаблону со списком адресов, успешно проверенных в этом цикле. ИИ не используется.",
    },
...
PROCESS_STEPS = {
    ...
    "5f8c4a86-5605-4c6d-8176-55ba3501bad4": [
        ...
        ("Сформировать уведомление с точной цитатой и адресами успешно проверенных источников", "Скрипт Бобби"),
