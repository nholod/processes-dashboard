...
OVERRIDES = {
    "5f8c4a86-5605-4c6d-8176-55ba3501bad4": {
        ...
        "6. Для Smart-Lab allblog сохраняются ID, дата, заголовок, URL и хэш; полный текст сохраняется при совпадении с портфелем.\n\n"
        ...
        "Проверка: все 13 адресов доступны; последний полный запуск завершён успешно, без потерь, дублей и ошибок. При первоначальной проверке 11 источников за 15 минут было найдено 17 новых материалов и 0 совпадений с портфелем; после добавления oblig_news и блога ДОХОДЪ новых совпадений также не обнаружено. В уведомлении каждый адрес получает ✅ или 🚫.",
    },
