...
OVERRIDES = {
    "5f8c4a86-5605-4c6d-8176-55ba3501bad4": {
        ...
        "5. В уведомлении указываются: точное или возможное совпадение, позиция и ISIN, портфель, основание совпадения, источник, время, точная цитата, ссылка и статус проверки каждого из 15 адресов.\n"
